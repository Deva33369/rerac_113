...
class Speedometer extends StatelessWidget {
  Speedometer(
      {required this.speed, required this.speedRecord, this.size = 300});
...
class SpeedometerPainter extends CustomPainter {
  SpeedometerPainter({required this.speed, required this.speedRecord});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawNeedle(0.15 + (speedRecord / 100), Colors.white54, size.width / 120);
    _drawNeedle(0.15 + (speed / 100), Colors.red, size.width / 70);
    _drawNeedleHolder();
    _drawSpeed();
  }
  ...
  void _drawGhostNeedle() {
    ...
    paintObject..color = Colors.white.withOpacity(0.5);
