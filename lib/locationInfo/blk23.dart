...
class blk23 extends StatefulWidget {
  const blk23({super.key});

  @override
  State<blk23> createState() => _blk23State();
}

class _blk23State extends State<blk23> {
  Map RiskData = {};
  ...
  getmarkers() {
    ...
    setState(() {
      for (int i = 0; i < 6; i++) {
        if (_getGeofence()[i].id.toString() == 'blk23') {
          risknum_blk23 == risknum[_getGeofence()[i].id.toString()];
        }
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Text(
                    "Risk Evaluation: ${risknum[_getGeofence()[3].id.toString()]!}",
                    style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                ...
                child: Center(
                  child: Text(
                    risknum[_getGeofence()[3].id.toString()]!,
                    style: TextStyle(color: Colors.white),
                  ),
                ),
              ),
