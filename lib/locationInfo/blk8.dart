...
class blk8 extends StatefulWidget {
  ...
  @override
  State<blk8> createState() => _blk8State();
}

class _blk8State extends State<blk8> {
  Map RiskData = {};
    ...
    setState(() {
      for (int i = 0; i < 6; i++) {
        if (_getGeofence()[i].id.toString() == 'blk8') {
          risknum_blk8 == risknum[_getGeofence()[i].id.toString()];
        }
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Text(
                    "Risk Evaluation: ${risknum[_getGeofence()[4].id.toString()]!}",
                    style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                ...
                child: Center(
                  child: Text(
                    risknum[_getGeofence()[4].id.toString()]!,
                    style: TextStyle(color: Colors.white),
                  ),
                ),
              ),
