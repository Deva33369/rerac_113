...
class blk51 extends StatefulWidget {
  ...
  @override
  State<blk51> createState() => _blk51State();
}

class _blk51State extends State<blk51> {
  Map RiskData = {};
  ...
  getmarkers() {
    ...
    setState(() {
      for (int i = 0; i < 6; i++) {
        if (_getGeofence()[i].id.toString() == 'blk51') {
          risknum_blk51 == risknum[_getGeofence()[i].id.toString()];
        }
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Text(
                    "Risk Evaluation: ${risknum[_getGeofence()[0].id.toString()]!}",
                    style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                ...
                child: Center(
                  child: Text(
                    risknum[_getGeofence()[0].id.toString()]!,
                    style: TextStyle(color: Colors.white),
                  ),
                ),
              ),
