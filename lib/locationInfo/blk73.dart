...
class blk73 extends StatefulWidget {
  const blk73({super.key});

  @override
  State<blk73> createState() => _blk73State();
}

class _blk73State extends State<blk73> {
  Map RiskData = {};
  ...
  getmarkers() {
    ...
    setState(() {
      for (int i = 0; i < 6; i++) {
        if (_getGeofence()[i].id.toString() == 'blk8') {
          risknum_blk73 == risknum[_getGeofence()[i].id.toString()];
        }
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Text(
                    "Risk Evaluation: ${risknum[_getGeofence()[2].id.toString()]!}",
                    style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                ...
                child: Center(
                  child: Text(
                    risknum[_getGeofence()[2].id.toString()]!,
                    style: TextStyle(color: Colors.white),
                  ),
                ),
              ),
