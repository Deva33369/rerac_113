...
class blk72 extends StatefulWidget {
  const blk72({super.key});

  @override
  State<blk72> createState() => _blk72State();
}

class _blk72State extends State<blk72> {
  Map RiskData = {};
  ...
  getmarkers() {
    ...
    setState(() {
      for (int i = 0; i < 6; i++) {
        if (_getGeofence()[i].id.toString() == 'blk72') {
          risknum_blk72 == risknum[_getGeofence()[i].id.toString()];
        }
          ...
          child: Center(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  Text(
                    "Risk Evaluation: ${risknum[_getGeofence()[1].id.toString()]!}",
                    style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              SizedBox(
                ...
                child: Center(
                  child: Text(
                    risknum[_getGeofence()[1].id.toString()]!,
                    style: TextStyle(color: Colors.white),
                  ),
                ),
              ),
